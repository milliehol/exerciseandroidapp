...
public class SelectGoals extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       //initialize widgets
        ...
        //loads preferences and populates list views with date and name in database
        loadPreferences();
        populateListView();
        populateListView2();

        //brings the user to the Check Goals page
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SelectGoals.this, CheckGoals.class));
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (itemID > -1) {
                    ...
                    editor.putString("athlete", date);
                    editor.putInt("athleteID", itemID);
                    editor.apply();
                    athlete = date;
                    vAthlete.setText(athlete);
                } else {
